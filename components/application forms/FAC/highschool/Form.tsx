...
import { ContactSchema, ContactType } from './schema/elementary';
...
import { customErrorMap } from './schema/elementary';
import { z } from 'zod';
import { handleSubmit_newImmigrant } from './hooks/handleSubmit_elementary';
...
const NewImmigrantForm: FC<NewImmigrantFormProps> = ({ ticket }) => {
    ...
    console.log(page);
    setValue('formLang', i18n.language || 'en');
    ...
    return (
        <>
            <form
                ...
                className={`flex flex-col px-[10%] pb-[10%] ${i18n.language == 'he' ? 'flex-row-reverse rtl' : 'ltr'}`}
            >
